...
[선택지 작성] ⚠️ 중요
- 8개, 반말체, 물음표 금지, 각 선택지는 15자 이내로 짧게
- 다양한 감정/반응을 포함 (동의, 반대, 더 말하기, 주제 전환, 조언 요청 등)
- 마지막 선택지(8번째)는 반드시 "조언해줘" 또는 "정리해줘"로!
- 예: ["맞아 그래서 힘들어", "진짜 그랬어", "더 말해도 돼", "근데 좀 달라", "나도 몰라", "다른 얘기할래", "그냥 들어줘", "조언해줘"]

[JSON 출력]
{
  "question": "상담사 응답",
  "options": ["선택지1", "선택지2", "선택지3", "선택지4", "선택지5", "선택지6", "선택지7", "선택지8"],
...
예: ["맞아 일리 있네", "근데 좀 다를 수도", "더 말해줘", "해볼게", "그건 아닌데", "정리해줘", "다른 방법은", "조언해줘"]`,

  F: `[F 모드 선택지] 반말체, 8개, 15자 이내
예: ["응 그래서 힘들어", "더 들어줘", "고마워", "나도 그래", "위로가 돼", "더 말할게", "그냥 안아줘", "조언해줘"]`,

  'reaction-bright': `[밝은 리액션 모드 선택지] 짧고 밝게, 8개, 10자 이내
예: ["그래!", "오 좋네", "와!", "ㅎㅎ", "맞아", "웅!", "좋아", "조언해줘"]`,

  'reaction-calm': `[차분한 리액션 모드 선택지] 짧고 차분하게, 8개, 10자 이내
예: ["음", "그래서", "그렇구나", "...", "응", "그러네", "알겠어", "조언해줘"]`,

  'listening-quiet': `[조용한 경청 모드 선택지] 짧게, 4~6개
예: ["...", "응", "더 말할게", "여기까지", "조언해줘"]`,

  'listening-active': `[적극적 경청 모드 선택지] 짧게, 6~8개
예: ["응응", "계속해", "더 말해줘", "그래그래", "알겠어", "들어줘", "조언해줘"]`,
};
